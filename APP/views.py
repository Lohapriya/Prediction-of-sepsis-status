...
Model = joblib.load('C:/Users/SPIRO-PYTHON/Desktop/UPCOMING/MUTHAPPA/ITPML23 - SEPSIS/deploy/PROJECT/APP/MODEL.pkl')
...
def Deploy_9(request): 
    if request.method == "POST":
        ...
        if output == 0:
            return render(request, '9_Deploy.html', {"prediction_text":"THE SEPSIS MIGHT NOT SPREAD IN THESE CONDITIONS."})
        elif output == 1:
            return render(request, '9_Deploy.html', {"prediction_text":"THE SEPSIS MIGHT SPREAD IN THESE CONDITIONS."})
